...
class BeersControllerTest < ActionController::TestCase
  ...
  test "should create beer" do
    assert_difference('Beer.count') do
      post :create, beer: { brewery: @beer.brewery, comment: @beer.comment, country: @beer.country, name: @beer.name, score: @beer.score, style: @beer.style }
    end
  ...
  test "should update beer" do
    put :update, id: @beer, beer: { brewery: @beer.brewery, comment: @beer.comment, country: @beer.country, name: @beer.name, score: @beer.score, style: @beer.style }
    assert_redirected_to beer_path(assigns(:beer))
  end
